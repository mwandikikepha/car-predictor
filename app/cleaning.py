...
def clean_listing(raw: dict) -> dict | None:
    ...
    # VALIDATION: reject impossible years (catches parser bugs like year=3008)
    if not year or year > 2026:
        return None
    
    # BUSINESS FILTER: only keep 2016+ for import analysis
    if year < 2016:
        return None
    
    # STRICT VALIDATION: require make and model
